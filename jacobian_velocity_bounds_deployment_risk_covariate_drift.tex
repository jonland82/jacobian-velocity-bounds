...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/figure_3_directional_ablation.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figures/figure_4_tetouan_deployment.png}
...
The author used standard computational tools and programming libraries, including Python packages and AI-assisted language tools from OpenAI and Anthropic, to support code development, algebraic checks, proof-verification scaffolding, repository hygiene, and editorial refinement. All mathematical statements, experiments, code, interpretations, and final text were conceptualized, reviewed, and finalized by the author, who is solely responsible for the content. The author received no external funding and reports no conflicts of interest.
