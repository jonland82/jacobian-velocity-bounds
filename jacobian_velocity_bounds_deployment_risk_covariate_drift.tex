...
The three empirical pieces play different roles. The time-domain sanity check asks whether the Poincare step is visible in trained models at all. The isotropic-versus-directional comparison asks whether the low-rank specialization has real design content. The Air Quality study asks whether the same directional quantities still matter once the setting becomes noisy and the drift subspace must be estimated. That progression is targeted evidence for the claim being made here rather than an attempt at broad benchmark coverage.
